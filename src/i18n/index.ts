...
const messages = {
  en: {
    ...
    admin: {
      ...
      championshipsCreateSubtitle:
        'Define schedule, status, sport and optional parent championship.',
      championshipsFormInfo:
        'Fill the form to draft a championship. API wiring will come later.',
      ...
      championshipSuccess:
        'Championship saved locally. Backend connection will be added soon.',
  ...
  fr: {
    ...
    admin: {
      ...
      championshipsCreateSubtitle:
        'Définir le calendrier, le statut, la discipline et un éventuel rattachement.',
      championshipsFormInfo:
        'Renseignez le formulaire pour préparer un championnat. Le lien API sera ajouté plus tard.',
      ...
      championshipSuccess:
        'Championnat enregistré localement. La connexion au backend sera ajoutée prochainement.',
